...
form.addEventListener("change", function(e) {
    ...
    checkInputValidity(changedInput);
});

form.addEventListener("submit", function(e) {
    e.preventDefault();
    if (!form.checkValidity()) {
        var fields = form.querySelectorAll("input"); // does work
        //var fields = form.elements; /// doesn't work on first element? Doesn't display error message.
