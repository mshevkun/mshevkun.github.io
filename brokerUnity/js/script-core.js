    ...
    c.prototype = {
        ...
        resize: function() {
            ...
            "mobile-landscape" == i || "mobile-portrait" == i ? t.heading_font.each(function() {
                parseInt(n(this).css("font-size")) > 48 && (n(this).attr("data-orig-font") || n(this).attr("data-orig-font", n(this).css("font-size")), n(this).css("font-size", "48px"))
